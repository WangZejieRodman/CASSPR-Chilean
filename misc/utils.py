...
class MinkLocParams:
    ...
    def __init__(self, params_path, model_params_path):
        ...
        assert self.dataset_name in ['USyd', 'IntensityOxford', 'Oxford', 'TUM', 'Chilean'], 'Dataset should be USyd, IntensityOxford ' \
                                                                           'or Oxford, TUM, Chilean'
        ...
        elif self.dataset_name == 'Chilean':
            self.eval_database_files = ['chilean_evaluation_database_100_179.pickle']
            self.eval_query_files = ['chilean_evaluation_query_180_209.pickle']
